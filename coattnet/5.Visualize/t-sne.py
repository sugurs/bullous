...
def testModelOnOneDataset(loaded_weights, test_data_dir):
    ...
    partial_model = Model(input=base_model.input, output=base_model.get_layer('avg_pool').output)
...
if __name__ == '__main__':
    ...
    hdf5_dir = '/media/wz209/a29353b7-1090-433f-b452-b4ce827adb17/sugurs/PythonProjects/pem_multi/Expirements/5.Visualize/1'
