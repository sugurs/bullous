...
def testModelOnOneDataset(loaded_weights, test_data_dir):
    ...
    file_img_test_res = []
    file_img_test_res.append(all_patient_truelabel_list)
    file_img_test_res.append(all_patient_pred_list)
    with open("file_img_test_res.pkl", "wb") as f:
        pickle.dump(file_img_test_res, f)

    file_patient_test_res = []
    file_patient_test_res.append(all_patient_in_one_truelabel_list)
    file_patient_test_res.append(all_patient_in_one_pred_list)
    with open("file_patient_test_res.pkl", "wb") as f:
        pickle.dump(file_patient_test_res, f)
...
if __name__ == '__main__':
    ...
    # 找所有的hdf5
    hdf5_dir = '/media/wz209/a29353b7-1090-433f-b452-b4ce827adb17/sugurs/' \
               'PythonProjects/pem_multi/Expirements/6.ManVsMachine/1/'
    findH5Count = 0
    for fpathe, dirs, fs in os.walk(hdf5_dir):
        for f in fs:
            ...
            if file.endswith('.hdf5'):
                ...
                testDir = '/media/wz209/a29353b7-1090-433f-b452-b4ce827adb17/sugurs/PythonProjects/pem_multi/dataset/crop40'
