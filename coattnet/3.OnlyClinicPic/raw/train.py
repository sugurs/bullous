...
def multi_input_model():
    ...
    model = Model(input=ClinicPicInput, output=predictions)
    return model
...
if __name__ == '__main__':
    ...
    subsetPrefix = '/media/wz209/a29353b7-1090-433f-b452-b4ce827adb17/sugurs/PythonProjects/pem_multi/dataset/raw/'
    AllImagePathLst = []
    AllImageDataLst = []
    AllFeature19Lst = []
    AllLabelLst = []
    ...
    for optimizeFunc in optimizeFuncLst:
        ...
        for testIndex in range(1, 5):
            if optimizeFunc != './backup/IncepResV2-Adam/' or testIndex != 3:
                continue
