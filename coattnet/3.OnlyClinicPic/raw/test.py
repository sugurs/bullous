...
def testModelOnOneDataset(loaded_weights, test_data_dir):
    ...
    evaluate = full_model.evaluate(test_images, test_labels, batch_size=30, verbose=0)
...
if __name__ == '__main__':
    ...
    # 找所有的hdf5
    hdf5_dir = '/media/wz209/a29353b7-1090-433f-b452-b4ce827adb17/sugurs/PythonProjects/pem_multi/Expirements/3.OnlyClinicPic/raw/backup'
    findH5Count = 0
        ...
        for f in fs:
            ...
            if file.endswith('.hdf5'):
                ...
                print 'Now is testing model #%d' % findH5Count, modelPath.replace(
                    '/media/wz209/a29353b7-1090-433f-b452-b4ce827adb17/sugurs/PythonProjects/pem_multi/Expirements/3.OnlyClinicPic/raw/backup/',
                    ''
                )
